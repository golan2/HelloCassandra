...
public abstract class AbsStrategyInsertCountersByClass extends AbsStrategyInsertCountersAggregated {
    AbsStrategyInsertCountersByClass(String[] args) {
        super(args);
    }
    ...
    public String getTableName() {
        return CassandraShared.T_COUNTERS_BY_CLASS;
    }
